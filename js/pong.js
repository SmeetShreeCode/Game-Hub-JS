...
class PongGame {
    ...
    setupUI() {
        ...
        document.getElementById('vsFriendBtn').addEventListener('click', () => {
            ...
            this.showFriendOptionSelection();
        });
        ...
        // Friend Option selection
        document.querySelectorAll('.friendOption-btn').forEach(btn => {
            btn.addEventListener('click', () => {
        ...
        document.querySelectorAll('.onlineOption-btn').forEach(btn => {
            ...
            btn.addEventListener('click', () => {
                ...
                if (onlineOption === 'createGame') {
                    ...
                    const id = document.getElementById('joinTheGame').value.trim();
                    if (!id) {
        ...
        document.getElementById('backToMenuFromFriendBtn').addEventListener('click', () => {
            this.hideFriendOptionSelection();
        });

        document.getElementById('backToFriendOptionBtn').addEventListener('click', () => {
            this.hideOnlineFriendOptionSelection();
        });
    ...
    showFriendOptionSelection() {
        document.getElementById('menuScreen').classList.add('hidden');
        document.getElementById('friendOptionScreen').classList.remove('hidden');
    }

    showOnlineFriendOptionSelection() {
        document.getElementById('friendOptionScreen').classList.add('hidden');
        document.getElementById('onlineFriendOptionScreen').classList.remove('hidden');
    }
    ...
    hideFriendOptionSelection() {
        document.getElementById('friendOptionScreen').classList.add('hidden');
        document.getElementById('menuScreen').classList.remove('hidden');
    }

    hideOnlineFriendOptionSelection() {
